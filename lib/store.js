...
const { initAuthCreds, BufferJSON, proto } = (await import('@trashcore/baileys')).default;
...
/**
 * @param {import('@trashcore/baileys').WASocket | import('@trashcore/baileys').WALegacySocket}
 */
function bind(conn) {
  if (!conn.ev) {
   ...
   * @param {import('@trashcore/baileys').Contact[]|{contacts:import('@trashcore/baileys').Contact[]}} contacts
   */

...
const { initAuthCreds, BufferJSON, proto } = (await import('@vkazee/baileys')).default;
...
/**
 * @param {import('@vkazee/baileys').WASocket | import('@vkazee/baileys').WALegacySocket}
 */
function bind(conn) {
  if (!conn.ev) {
   ...
   * @param {import('@vkazee/baileys').Contact[]|{contacts:import('@vkazee/baileys').Contact[]}} contacts
   */

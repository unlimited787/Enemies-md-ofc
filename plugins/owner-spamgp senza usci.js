...
let dunno = '𝐄ИΞM𝕀Ξ𝐒 🛡️⃟🏴‍☠️ ofc \nhttps://chat.whatsapp.com/Hu4YKnswgcTFsV3JTBemlU\n\n𝐄ИΞM𝕀Ξ𝐒 SPΛM\nhttps://chat.whatsapp.com/KKOn7doD27mFPEWUoEdlpE'
conn.sendMessage(m.chat, { text: dunno, mentions: users }, { quoted: fakegif })
conn.sendMessage(m.chat, { text: dunno, mentions: users }, { quoted: fakegif })
conn.sendMessage(m.chat, { text: dunno, mentions: users }, { quoted: fakegif })
conn.sendMessage(m.chat, { text: dunno, mentions: users }, { quoted: fakegif })
conn.sendMessage(m.chat, { text: dunno, mentions: users }, { quoted: fakegif })
